    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['status'], name='clientes_cl_status_b31356_idx'), models.Index(fields=['ultimo_atendimento'], name='clientes_cl_ultimo__24c623_idx'), models.Index(fields=['empresa', 'status'], name='clientes_cl_empresa_70e14f_idx')],
            },
        ),
    ]
